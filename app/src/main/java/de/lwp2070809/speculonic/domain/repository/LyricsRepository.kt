...
class LyricsRepository(
    ...
    private val activeFetches = java.util.concurrent.ConcurrentHashMap<String, kotlinx.coroutines.Deferred<Pair<String?, List<LyricLine>>>>()
